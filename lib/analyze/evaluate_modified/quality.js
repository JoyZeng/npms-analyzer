...
const log = logger.child({ module: 'evaluate_modified/quality' });
...
function evaluateCarefulness(collected) {
    ...
    return (licenseEvaluation * 0.246571 +
            readmeEvaluation * 0.325454 +
            lintersEvaluation * 0.124092
...
function evaluateTests(collected) {
    ...
    return testsEvaluation * 0.684849 +
           coverageEvaluation * 0.262252;
}
