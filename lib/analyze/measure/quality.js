...
const log = logger.child({ module: 'measure/quality' });
...
function evaluateCarefulness(collected) {
    ...
    return {
        ...
        readme_size: get(collected, 'source.files.readmeSize', 0),
        readme_evaluation: readmeEvaluation,
        linters: lintersEvaluation,
        ignore_file: ignoreEvaluation,
        changelog: changelogEvaluation,
...
function evaluateTests(collected) {
    ...
    return {
        tests_size: collected.source.files.testsSize,
        tests_evaluation: testsEvaluation,
...
function evaluateHealth(collected) {
    if (!collected.source) {
        // return 0;
        return {
            outdated_count: undefined,
            dependencies_count: undefined,
            vulnerabilities_count: undefined,
            unlocked_count: undefined,
            outdated_evaluation: undefined,
            vulnerabilities_evaluation: undefined
        }
    }
    ...
    if (!dependenciesCount) {
        ...
        return {
            ...
            unlocked_count: 0,
            outdated_evaluation: 0,
            vulnerabilities_evaluation: 0
        }
    }
    ...
    return {
        ...
        outdated_evaluation: outdatedEvaluation,
        vulnerabilities_evaluation: vulnerabilitiesEvaluation
    }
}
...
function evaluateBranding(collected) {
    ...
    return {
        ...
        badges_evaluation: badgesEvaluation
    }
}
...
function quality(collected) {
    ...
    const carefulness = evaluateCarefulness(collected);
    const tests = evaluateTests(collected);
    const health = evaluateHealth(collected);
    const branding = evaluateBranding(collected);

    return {
        license: carefulness.license,
        readme_size: carefulness.readme_size,
        readme_evaluation: carefulness.readme_evaluation,
        linters: carefulness.linters,
        ignore_file: carefulness.ignore_file,
        changelog: carefulness.changelog,
        is_deprecated: carefulness.is_deprecated,
        is_stable: carefulness.is_stable,
        tests_size: tests.tests_size,
        tests_evaluation: tests.tests_evaluation,
        coverage: tests.coverage,
        status: tests.status,
        outdated_count: health.outdated_count,
        dependencies_count: health.dependencies_count,
        vulnerabilities_count: health.vulnerabilities_count,
        unlocked_count: health.unlocked_count,
        outdated_evaluation: health.outdated_evaluation,
        vulnerabilities_evaluation: health.vulnerabilities_evaluation,
        homepage: branding.homepage,
        badges_count: branding.badges_count,
        badges_evaluation: branding.badges_evaluation
    }
}
